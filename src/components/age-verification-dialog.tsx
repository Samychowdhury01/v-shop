...
export function AgeVerificationDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={() => {}}>
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center text-black">Age Verification</DialogTitle>
          <DialogDescription className="text-center text-zinc-700 pt-4">
        ...
        <div className="flex gap-4 pt-6">
          ...
          <Button onClick={handleYes} className="flex-1 bg-black text-white hover:bg-zinc-800">
            Yes, I am 18+
          </Button>
        </div>
      </DialogContent>
